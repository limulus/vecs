...
SVGElement.prototype.viewportDimensions = function () {
  var elem = this.rawSVGElement()
  elem = elem.viewBox && elem.viewBox.baseVal ? elem : elem.viewportElement
  return elem.viewBox.baseVal
}

SVGElement.prototype.setId = function (id) {
